<?php  
	include 'core/functions/session.func.php';
?>
	...
	<div class="cd-user-modal"> <!-- this is the entire modal form, including the background -->
		<div class="cd-user-modal-container"> <!-- this is the container wrapper -->
			...
			<div id="cd-login"> <!-- log in form -->
				<form class="cd-form" method="POST" action="core/functions/signup.func.php">
					<p class="fieldset">
...
<!-- 						<span class="cd-error-message">Error message here!</span> -->
			...
			<div id="cd-signup"> <!-- sign up form -->
				<form class="cd-form" method="POST" action="core/functions/signup.func.php">
						...
						<input class="full-width has-padding has-border" id="signup-username" type="text" placeholder="Firstname" name="firstname" >
 							<?php
								if (isset($_SESSION['message'])) {
									echo "<span class='cd-error-message'>".$_SESSION['message']."</span>";
					...
					<p class="fieldset">
						<label class="image-replace cd-password" for="signup-password">Password again</label>
						<input class="full-width has-padding has-border" id="signup-password" type="text" placeholder="Password again" name="password2"
						> 
						<a href="#0" class="hide-password">Hide</a>
 							<?php
								if (isset($_SESSION['message'])) {
