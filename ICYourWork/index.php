...
<html >
  <head>
    ...
    <meta name="description" content="Welcome - ICYourWork">
      ...
      <div class="new-user">
        <?php
          if (isset($_SESSION['notset'])) {
            echo "<div class='denied-message'>".$_SESSION['notset']."</div>";
            unset($_SESSION['notset']);
          }
        ?>
        <span class="title">Welcome to ICYourWork</span>
        <span class="subtitle">Online job finding platform</span>
          <a class="join-button" id="applicant" value="1" href="register.php?id=1">Join as a job applicant</a>
          <a class="join-button" id="employee" value="2" href="register.php?id=2">Join as a employee</a>
      </div>
